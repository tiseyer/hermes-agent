    ...
    ),
    {
        ...
        "initial_status": {
            ...
            "description": (
                ...
                "brief running-to-blocked transition, or 'backlog' to "
                "park the card until a human moves it to todo. Defaults "
                "to 'running', which preserves the usual dispatch path."
            ),
        },
        "skills": {
            "type": "array",
